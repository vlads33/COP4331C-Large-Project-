            ...
            <section className="flex flex-col items-center justify-center flex-grow text-center px-6">
                ...
                <div className="flex gap-9">
                    ...
                    <button
                        ...
                        className="bg-yellow-400 text-gray-900 font-semibold px-6 py-3 rounded-lg hover:bg-yellow-500 transition duration-300"
                    >
                        Explore Listings
                    </button>
                    ...
                    <button
                        ...
                        className="border border-yellow-400 text-yellow-400 font-semibold px-6 py-3 rounded-lg hover:bg-yellow-400 hover:text-gray-900 transition duration-300"
                    >
                        Create Listing
                    </button>
                </div>
